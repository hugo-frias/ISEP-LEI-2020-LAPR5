...
{
    [TestClass]
    public class DriverDutyControllerUnitTest
    {
        ...
        public async Task Test_AddAsync_Success()
        {
            ...
            .Returns(Task.FromResult(DriverDutyMapper.toDomain(driverDutyDto)));
        ...
        public async Task Test_AddAsync_Insuccess()
        {
            ...
            new BusinessRuleValidationException("error getting workblock");
        ...
        [TestMethod]
        public async Task Test_AddAsync_Insuccess2()
        {
            ...
            mockWorkBlock.Verify(repo => repo.GetByIdAsync(It.IsAny<WorkBlockId>()), Times
                        .AtLeastOnce());
            mock.Verify(service => service.AddAsync(It.IsAny<DriverDuty>()), Times.Never());
        ...
        public async Task Test_GetByIdAsync_Success()
        {
            ...
            DriverDutyDto driverDuty = new DriverDutyDto("3143bfe6-6d24-439e-9e18-e22bd1cd4ba6", "DriverDuty:02", "nome", "#5f0092", workBlocks);
        ...
        public async Task Test_GetAllAsync_Insuccess()
        {
            ...
            BusinessRuleValidationException exception =
                        new BusinessRuleValidationException("error getting driver duties");
